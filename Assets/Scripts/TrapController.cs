    ...
    public override void OnInspectorGUI()
    {
        ...
        switch (example.type)
        {
            case TrapController.Options.FlyingBooks:
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("direction"), true); // Display GameObject[] in a foldout
                EditorGUILayout.PropertyField(serializedObject.FindProperty("selectedAxis"), true); // Display GameObject[] in a foldout
                EditorGUILayout.PropertyField(serializedObject.FindProperty("audioSource"), true); // Display GameObject[] in a foldout
                break;
            
            case TrapController.Options.Music:
                EditorGUILayout.PropertyField(serializedObject.FindProperty("audioClips"), true); // Display GameObject[] in a foldout
                EditorGUILayout.PropertyField(serializedObject.FindProperty("audioSource"), true); // Display GameObject[] in a foldout
                
                break;
            
            case TrapController.Options.Lights:
                EditorGUILayout.PropertyField(serializedObject.FindProperty("lightLamp"), true); // Display GameObject[] in a foldout
